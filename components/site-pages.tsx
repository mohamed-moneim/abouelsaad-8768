...
const blogImages = ['https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=1200&q=85', 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1200&q=85', 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&w=1200&q=85']
...
export function HomePage() {
  ...
  return <PageShell>
    ...
    <section className="section-wrap blog"><p className="muted mono">My Latest Articles</p><SectionTitle title="Blog" /><div className="blog-grid">{blogImages.map((src, i) => <article key={src}><img src={src} alt="" /><h3>{['AI will Transform Education', 'New Features in Latest Release of Node.js', 'Top Skills should be adopted by Software Engineers'][i]}</h3></article>)}</div></section>
  </PageShell>
}
...
export function BlogPage() { return <PageShell><section className="section-wrap blog page-section"><p className="muted mono">My Latest Articles</p><SectionTitle title="Blog" /><div className="blog-grid">{blogImages.map((src, i) => <article key={src}><img src={src} alt="" /><h3>{['AI will Transform Education', 'New Features in Latest Release of Node.js', 'Top Skills should be adopted by Software Engineers'][i]}</h3></article>)}</div></section></PageShell> }
