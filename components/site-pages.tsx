...
function BlogCards({ limit }: { limit?: number }) {
  ...
  const articles = articlesFromResponse(data as Article[] | { articles?: Article[] }).slice(0, limit)
