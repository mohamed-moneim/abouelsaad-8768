    ...
    <main>
      ...
      <section id="home" className="hero section-wrap">
        <div className="hero-copy">
          ...
          <div className="button-row"><a href="/contact" className="button button-primary">Let&apos;s Collaborate</a><a href="/services" className="button button-outline">Learn More</a></div>
        </div>
